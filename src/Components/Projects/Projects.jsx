      ...
      <div className="container projects__container">
        ...
        <ul className="projects__list">
          <li className="projects__item">
            <img src={ProjectImg} alt="" className="projects__item-image"/>
            <h3 className="projects__item-title">Project Title goes here</h3>
          ...
          <li className="projects__item">Project 2</li>
          <li className="projects__item">Project 3</li>
        </ul>
      </div>
    </div>
  );
